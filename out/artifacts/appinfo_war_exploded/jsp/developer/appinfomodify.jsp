          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
            	<input id="statusName" type="text" class="form-control col-md-7 col-xs-12" 
              	name="statusname" value="${appInfo.apps.statusname}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
				<input type="hidden" id="logoPicPath" name="logopicpath" value="${pageContext.request.contextPath }${appInfo.logopicpath}"/>
