...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form method="post" action="appLevenOneList">
                    <input type="hidden" name="pageIndex" value="1"/>
                    <input type="hidden" name="opt" value="dev"/>
                    <ul>
                        <li>
                                    ...
                                    <select name="categorylevel2" id="queryCategoryLevel2" class="form-control">
                                        <c:if test="${categoryLevel2List != null }">
                                            ...
                                            <c:forEach var="appCategory" items="${categoryLevel2List}">
                                                <option
                                                        <c:if test="${appCategory.id == appInfo.categorylevel2 }">selected="selected"</c:if>
                                                        value="${appCategory.id}">${appCategory.categoryname}</option>
                                            </c:forEach>
                                        </c:if>
                                    </select>
                                    ...
                                    <select name="categorylevel3" id="queryCategoryLevel3" class="form-control">
                                        <c:if test="${categoryLevel3List != null }">
                                            ...
                                            <c:forEach var="appCategory" items="${categoryLevel3List}">
                                                <option
                                                        <c:if test="${appCategory.id == appInfo.categorylevel3 }">selected="selected"</c:if>
                                                        value="${appCategory.id}">${appCategory.categoryname}</option>
                                            </c:forEach>
                                        </c:if>
                                    </select>
                            ...
                            <table id="datatable-responsive"
                                ...
                                <c:forEach var="appInfo" items="${appInfoList }" varStatus="status">
                                    <tr role="row" class="odd">
                                        ...
                                        <td>${appInfo.apps.flatformname }</td>
                                        <td>${appInfo.apps.categorylevel1name } -> ${appInfo.apps.categorylevel2name }
                                            -> ${appInfo.apps.categorylevel3name }</td>
                                        <td><span id="appInfoStatus${appInfo.id}">${appInfo.apps.statusname }</span>
                                        </td>
                                        <td>${appInfo.downloads }</td>
                                        <td>${appInfo.apps.versionno }</td>
                                        <td>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li><a class="modifyVersion"
                                                           ...
                                                           statusname="${appInfo.apps.statusname }"
                                                           data-toggle="tooltip" data-placement="top" title=""
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="dataTables_info" id="datatable-responsive_info"
                                ...
                                ${pages.currentPage }/${pages.totalNum }页
                            </div>
                        </div>
                        <div class="col-sm-7">
                            <div class="dataTables_paginate paging_simple_numbers"
                                ...
                                <ul class="pagination">
                                    ...
                                    <c:if test="${pages.currentPage < pages.totalNum }">
                                        <li class="paginate_button "><a
                                                href="javascript:page_nav(document.forms[0],${pages.currentPage+1 });"
                                                aria-controls="datatable-responsive" data-dt-idx="1"
                                                tabindex="0">下一页</a>
                                        ...
                                        <li class="paginate_button next"><a
                                                href="javascript:page_nav(document.forms[0],${pages.totalNum });"
