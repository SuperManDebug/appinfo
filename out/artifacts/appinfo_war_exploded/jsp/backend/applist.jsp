							...
							<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
								...
								<c:forEach var="appInfo" items="${appInfoList }" varStatus="status">
									<tr role="row" class="odd">
										...
										<td>${appInfo.apps.categorylevel1name } -> ${appInfo.apps.categorylevel2name } -> ${appInfo.apps.categorylevel3name }</td>
										<td>${appInfo.apps.statusname }</td>
					...
					<div class="row">
						<div class="col-sm-5">
							<div class="dataTables_info" id="datatable-responsive_info"
								...
								${pages.currentPage }/${pages.totalNum }页</div>
						</div>
						<div class="col-sm-7">
