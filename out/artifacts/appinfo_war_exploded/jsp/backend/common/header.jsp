...
<c:if test="${empty backendUser}"><script>location.href='${pageContext.request.contextPath }/manager/login'</script></c:if>
<!DOCTYPE html>
<html lang="en">
  <head>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> APP管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath }/AppCategory/appLevenOneList?opt=back">APP审核</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="${pageContext.request.contextPath }/managers/logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
